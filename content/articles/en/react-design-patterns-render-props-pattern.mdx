...
excerpt: React Design Patterns: Render Props Pattern
---

Dealing with cross-cutting concerns by sharing stateful logic between components.Dealing with cross-cutting concerns by sharing stateful logic between components.Photo by[Alfonso Navarro](https://unsplash.com/@poncho_nj?utm_source=medium&utm_medium=referral)on[Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)
